      ...
      <Grid size={{ xs: 12, md: 7 }}>
        {mode === 'crear' ? (
          <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ m: 1 }} spacing={1} alignItems={{ xs: 'stretch', sm: 'center' }}>
            {/* 👇 Se oculta cuando ya existe code (tras onCreate en el padre) */}
            {!code && (
              <Button
                variant="contained"
            ...
            <Divider
              orientation={{ xs: 'horizontal', sm: 'vertical' } as any}
              flexItem
              sx={{ mx: { sm: 1 }, my: { xs: 1, sm: 0 } }}
            />
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} alignItems={{ xs: 'stretch', sm: 'center' }}>
            <TextField
              ...
              sx={{ backgroundColor: "white", borderRadius: 1, textAlign: 'center', width: { xs: '100%', sm: 180 } }}
            />
